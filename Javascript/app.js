...
innerHTML+=`<li class="songItem">
<div class="img_play"><img src="i/${i+1}.jfif" alt="1D">
...
//<button onclick="playSong(${i+1})"><img src="i/${i+1}.jfif" alt="1D"> </button>
document.getElementById("songList1").innerHTML=innerHTML;


innerHTML=""
for(j=0;j<trend.length; j++){
innerHTML+= ` <li class="songItem">
<div class="img_play"> <img src="i/${trend[j].id}.jfif" alt="1D">

    <i class="bi playListPlay bi-play-circle-fill" id="${trend[j].id}"></i>
</div>
<h5>
    ${trend[j].songName}
</h5>
...
document.getElementById("songList2").innerHTML=innerHTML;
...
masterPlay.addEventListener('click',()=>{
    if (music.paused || music.currentTime <=0) {
        ...
        if(index<=16){
            ...
            document.getElementById("title").innerHTML=`${trend[index-16-1].songName}<br>
            <div class="subtitle" id="songDescription"></div>`
            document.getElementById("Image").innerHTML=`<img  src="i/${index}.jfif" alt="TRY">`
        }       
